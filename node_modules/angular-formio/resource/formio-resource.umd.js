(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('lodash'), require('formiojs'), require('rxjs'), require('@angular/router'), require('formiojs/utils/Evaluator'), require('@angular/common'), require('@angular/elements'), require('native-promise-only'), require('@angular/forms'), require('ngx-bootstrap/pagination')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'lodash', 'formiojs', 'rxjs', '@angular/router', 'formiojs/utils/Evaluator', '@angular/common', '@angular/elements', 'native-promise-only', '@angular/forms', 'ngx-bootstrap/pagination'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['formio-resource'] = {}, global.core, global._, global.formiojs, global.rxjs, global.router, global.Evaluator, global.common, null, global.Promise$1, global.forms, global.pagination));
}(this, (function (exports, core, _, formiojs, rxjs, router, Evaluator, common, elements, Promise$1, forms, pagination) { 'use strict';
    ...
    var FormioResourceService = /** @class */ (function () {
        function FormioResourceService(appConfig, config, resourcesService, appRef) {
            ...
            this.formLoaded = new Promise__default['default']((/**
             * @param {?} resolve
             * @param {?} reject
             * @return {?}
             */
        ...
        function () {
            ...
            function (form) {
                ...
                return Promise__default['default'].all(_parentsLoaded).then((/**
                 * @param {?} parents
                 * @return {?}
                 */
                function (parents) {
