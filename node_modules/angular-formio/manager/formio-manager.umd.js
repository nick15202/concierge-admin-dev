(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('formiojs'), require('lodash'), require('lodash/each'), require('lodash/intersection'), require('@angular/router'), require('rxjs'), require('formiojs/utils/Evaluator'), require('@angular/common'), require('@angular/elements'), require('ngx-bootstrap/modal'), require('@angular/forms'), require('ngx-bootstrap/pagination')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'formiojs', 'lodash', 'lodash/each', 'lodash/intersection', '@angular/router', 'rxjs', 'formiojs/utils/Evaluator', '@angular/common', '@angular/elements', 'ngx-bootstrap/modal', '@angular/forms', 'ngx-bootstrap/pagination'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['formio-manager'] = {}, global.core, global.formiojs, global._, global._each, global._intersection, global.router, global.rxjs, global.Evaluator, global.common, null, global.modal, global.forms, global.pagination));
}(this, (function (exports, core, formiojs, _, _each, _intersection, router, rxjs, Evaluator, common, elements, modal, forms, pagination) { 'use strict';
        ...
        function () {
            ...
            if (this.auth) {
                ...
                function () {
                    /** @type {?} */
                    var adminRoles = [];
                    _each__default['default'](_this.auth.roles, (/**
                     * @param {?} role
                     * @param {?} name
                     * @return {?}
                     */
    ...
    var FormGridBodyComponent = /** @class */ (function (_super) {
        ...
        FormGridBodyComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        styles: [".form-btn { font-size: 0.75rem; margin: 2px 0; } "],
                        template: "<ng-template> <tbody *ngIf=\"rows\"> <tr *ngFor=\"let form of rows\"> <td> <div class=\"row\"> <div class=\"col-sm-8\"> <a routerLink=\"{{form._id}}/view\" (click)=\"onRowSelect($event, form)\"><h5>{{ form.title }}</h5></a> </div> <div class=\"col-sm-4\"> <button *ngIf=\"actionAllowed('formView')\" class=\"btn btn-outline-secondary btn-sm form-btn\" (click)=\"onRowAction($event, form, 'view')\"><span class=\"fa fa-pencil\"></span> Enter Data</button>&nbsp; <button *ngIf=\"actionAllowed('submissionIndex')\" class=\"btn btn-outline-secondary btn-sm form-btn\" (click)=\"onRowAction($event, form, 'submission')\"><span class=\"fa fa-list-alt\"></span> View Data</button>&nbsp; <button *ngIf=\"actionAllowed('formEdit')\" class=\"btn btn-outline-secondary btn-sm form-btn\" (click)=\"onRowAction($event, form, 'edit')\"><span class=\"fa fa-edit\"></span> Edit Form</button>&nbsp; <button *ngIf=\"actionAllowed('formDelete')\" class=\"btn btn-danger btn-sm form-btn\" (click)=\"onRowAction($event, form, 'delete')\"><span class=\"fa fa-trash\"></span></button> </div> </div> </td> </tr> </tbody> </ng-template> "
                    },] },
        ];
    ...
    var SubmissionGridBodyComponent = /** @class */ (function (_super) {
        ...
        function (submission, header) {
            /** @type {?} */
            var cellValue = _.get(submission, header.key);
    ...
    function extendRouter(Class, config, ClassRoutes) {
        _.each(Class.decorators, (/**
         * @param {?} decorator
         * @return {?}
         */
        function (decorator) {
            _.each(decorator.args, (/**
             * @param {?} arg
             * @return {?}
             */
            function (arg) {
    ...
    var FormioBaseComponent = /** @class */ (function () {
        ...
        function (value, flags, isModified) {
            if (this.watchSubmissionErrors && !this.submissionSuccess) {
                /** @type {?} */
                var errors = _.get(this, 'formio.errors', []);
                /** @type {?} */
                var alerts = _.get(this, 'alerts.alerts', []);
                /** @type {?} */
                var submitted = _.get(this, 'formio.submitted', false);
    ...
    var FormioComponent = /** @class */ (function (_super) {
        __extends$6(FormioComponent, _super);
    ...
    var FormBuilderComponent = /** @class */ (function () {
        ...
        function (form, options) {
            ...
            /** @type {?} */
            var extraTags = this.customTags ? this.customTags.tags : [];
            this.builder = new Builder(this.builderElement.nativeElement, form, _.assign({
                icons: 'fontawesome',
                sanitizeConfig: {
                    addTags: extraTags
                }
    ...
    /** @type {?} */
    formiojs.Components.components.input;
    /** @type {?} */
    formiojs.Components.components.textfield;
    ...
    var FormManagerIndexComponent = /** @class */ (function () {
        ...
        FormManagerIndexComponent.propDecorators = {
            formGrid: [{ type: core.ViewChild, args: [FormioGridComponent, { static: false },] }]
        };
    ...
    var FormManagerEditComponent = /** @class */ (function () {
        ...
        FormManagerEditComponent.propDecorators = {
            builder: [{ type: core.ViewChild, args: [FormBuilderComponent, { static: false },] }],
    ...
    var FormManagerCreateComponent = /** @class */ (function (_super) {
        __extends$7(FormManagerCreateComponent, _super);
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: manager/form-manager.routes.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    /**
     * @param {?=} config
