...
var SubmissionDeleteComponent = /** @class */ (function () {
    ...
    SubmissionDeleteComponent.decorators = [
        { type: Component, args: [{
                    template: "<formio-alerts [alerts]=\"alerts\"></formio-alerts> <h3>Are you sure you wish to delete this record?</h3> <div class=\"btn-toolbar\"> <button type=\"button\" (click)=\"onDelete()\" class=\"btn btn-danger\" style=\"margin-right: 10px;\">Yes</button> <button type=\"button\" (click)=\"onCancel()\" class=\"btn btn-default\">No</button> </div> "
                },] },
    ];
    /** @nocollapse */
